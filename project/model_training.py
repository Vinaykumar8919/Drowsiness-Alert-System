...
train_data= train_datagen.flow_from_directory(os.path.join('data', 'Prepared_Data', 'Train'),
                                target_size = (80,80), batch_size = BATCH_SIZE, 
                                class_mode = 'categorical',subset='training' )

validation_data= train_datagen.flow_from_directory(os.path.join('data', 'Prepared_Data', 'Train'),
                                target_size = (80,80), batch_size = BATCH_SIZE, 
...
test_data = test_datagen.flow_from_directory(os.path.join('data', 'Prepared_Data', 'Test'),
